...
# translation
SOURCES = getwkt.py ui_getwkt.py __init__.py getwktdialog.py
#TRANSLATIONS = i18n/getwkt_en.ts
TRANSLATIONS =
...
PY_FILES = getwkt.py getwktdialog.py __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = ui_getwkt.py
